...
More information on the program and specific functions:
...
library(ggrepel)
library(devtools)
#library(vsn) Need this updated version for new R
library(dplyr)
library(plyr)
library(ggplot2)
library(knitr)
...
# save rlogged file (saving full results contrast table, and below p-adjusted table)
saveRDS(results_LO_LC_.1, file = "Past_sym_DE_genes_LO_LC.rds")
...
# save rlogged file
saveRDS(DE_LO_LC_padj.1, file = "Past_sym_DE_genes_LO_LC_padj.1.rds")
write.csv(DE_LO_LC_padj.1, "Past_sym_DE_genes_LO_LC_padj.1.csv")
```
...
# save file
write.csv(down.results_LO_LC_padj.1, file="Past_sym_DE_genes_LO_LC_padj.1_summary.csv")
```
...
saveRDS(DE_LO_LC_pvalue, file = "Past_sym_LO_LC_pval.05.rds")
write.csv(DE_LO_LC_pvalue, "Past_sym_LO_LC_pval.05.csv")
```
...
# save rlogged file (saving full results contrast table, and below p-adjusted table)
saveRDS(results_OO_LO_.1, file = "Past_sym_DE_genes_OO_LO.rds")
...
# save rlogged file
saveRDS(DE_OO_LO_padj.1, file = "Past_sym_DE_genes_OO_LO_padj.1.rds")
write.csv(DE_OO_LO_padj.1, "Past_sym_DE_genes_OO_LO_padj.1.csv")
```
...
# save file
write.csv(OO_LO_padj.1_summary, file="Past_sym_DE_genes_OO_LO_padj.1_summary.csv")
```
...
# save rlogged and csv files
saveRDS(DE_OO_LO_pvalue, file = "Past_sym_OO_LO_pval.05.rds")
write.csv(DE_OO_LO_pvalue, "Past_sym_OO_LO_pval.05.csv")
```
...
# save rlogged file (saving full results contrast table, and below p-adjusted table)
saveRDS(results_OO_OC_.1, file = "Past_sym_DE_genes_OO_OC.rds")
...
# save rlogged file
saveRDS(DE_OO_OC_padj.1, file = "Past_sym_DE_genes_OO_OC_padj.1.rds")
write.csv(DE_OO_OC_padj.1, "Past_sym_DE_genes_OO_OC_padj.1.csv")
```
...
# save file
write.csv(OO_OC_padj.1_summary, file="Past_sym_DE_genes_OO_OC_padj.1_summary.csv")
```
...
# save rlogged and csv files
saveRDS(DE_OO_OC_pvalue, file = "Past_sym_OO_OC_pval.05.rds")
write.csv(DE_OO_OC_pvalue, "Past_sym_OO_OC_pval.05.csv")
```
...
# save rlogged file (saving full results contrast table, and below p-adjusted table)
saveRDS(results_OC_LC_.1, file = "Past_sym_DE_genes_OC_LC.rds")
...
# save rlogged and csv files
saveRDS(DE_OC_LC_pvalue, file = "Past_sym_OC_LC_pval.05.rds")
write.csv(DE_OC_LC_pvalue, "Past_sym_OC_LC_pval.05.csv")
```
...
# save rlogged file
saveRDS(DE_OO_LC_padj.1, file = "Past_sym_DE_genes_OO_LC_padj.1.rds")
write.csv(DE_OO_LC_padj.1, "Past_sym_DE_genes_OO_LC_padj.1.csv")
```
...
# save file
write.csv(OO_LC_padj.1_summary, file="Past_sym_DE_genes_OO_LC_padj.1_summary.csv")
```
...
# save rlogged and csv files
saveRDS(DE_OO_LC_pvalue, file = "Past_sym_OO_LC_pval.05.rds")
write.csv(DE_OO_LC_pvalue, "Past_sym_OO_LC_pval.05.csv")
```
