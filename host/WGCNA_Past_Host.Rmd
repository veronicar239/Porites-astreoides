...
# dim(dat)
#### 29 8118
# drop <- c("NC_292_La_Pa_yr2", "NC_320_La_Pa_yr2", "NC_311_La_Pa_yr2", "NO_265_La_Pa_yr2", "NO_274_La_Pa_yr2", "NO_280_La_Pa_yr2", "NO_268_La_Pa_yr2")
# dat <- dat[!(row.names(dat) %in% drop),]
# dat <- droplevels(dat)
# dim(dat)
#### 25 8118
...
1      4  0.00343 -0.449          0.974  735.00    723.00 1100.0
2      5  0.05510 -1.450          0.963  447.00    437.00  751.0
3      6  0.15700 -2.030          0.965  281.00    273.00  527.0
4      7  0.26700 -2.280          0.967  181.00    175.00  378.0
5      8  0.39500 -2.500          0.975  120.00    114.00  279.0
6      9  0.51400 -2.700          0.984   81.10     76.50  209.0
7     10  0.60600 -2.820          0.990   55.90     52.00  159.0
8     12  0.72700 -2.910          0.996   27.90     25.20   95.4
9     14  0.77600 -2.800          0.997   14.80     12.90   59.6
10    16  0.81900 -2.670          0.996    8.27      6.88   38.6
11    18  0.85400 -2.570          0.997    4.81      3.83   25.7
12    20  0.87700 -2.660          0.998    2.90      2.21   18.9
...
dynamicMergeCut(25) # calculates the threshold for module merging using the number of samples
```


```{r}
MEDissThres = 0.2507698
