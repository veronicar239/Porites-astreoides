...
#saveRDS(results.dds, file = "dds.results_Past_Host.rds")
#write.csv(file = "dds.results_Past_Host.csv", x = results.dds)
...
saveRDS(dds, file = "dds_Past_Host.rds")
```
...
saveRDS(results_LO_LC_.1, file = "Past_Host_DE_genes_LO_LC.rds")
...
# save rlogged file (saving full results contrast table, and below p-adjusted table)
saveRDS(results_OO_LO_.1, file = "Past_Host_DE_genes_OO_LO.rds")
...
# save rlogged file (saving full results contrast table, and below p-adjusted table)
saveRDS(results_OO_OC_.1, file = "Past_Host_DE_genes_OO_OC.rds")
...
# save rlogged file (saving full results contrast table, and below p-adjusted table)
saveRDS(results_OC_LC_.1, file = "Past_Host_DE_genes_OC_LC.rds")
